...
```{r Raw files}
file_names <- dir(path = "../inst/extdata/BBEA_mOIT_IgE", pattern=".csv", 
...
We can see that epitope-specific IgE decreased in both Omalizumab and Placebo groups, with more changes (in 63 epitope-specific IgE) in the Placebo group. 
